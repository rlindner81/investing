# Workday, Inc. (WDAY) — Business Plan

> **Fiscal year ends January 31.** FY2026 = Feb 1, 2025 – Jan 31, 2026. All
> quarter labels in this repo use the fiscal-year convention (e.g. `q1-fy2027`
> ended 2026-04-30). Figures below are as reported to the SEC.

## Company Overview

- **Founded:** 2005 by **Dave Duffield** and **Aneel Bhusri**, both former
  PeopleSoft executives, after Oracle's hostile takeover of PeopleSoft. Built
...
Growth levers: new logos, **seat/headcount expansion** within existing
customers, cross-sell of additional modules (Financials into an HCM base and vice
versa), international expansion, and price/mix from newer AI and analytics SKUs.

## Product Portfolio

- **Workday HCM (Human Capital Management):** the founding product — core HR,
  payroll, talent, workforce management, recruiting (Workday Recruiting), and
  learning. The market-leading cloud HCM suite for large enterprises.
- **Workday Financial Management:** cloud ERP/accounting, revenue management,
  procurement, expenses, and analytics — the primary land-and-expand adjacency to
  HCM and a key growth driver.
- **Workday Adaptive Planning:** enterprise planning, budgeting and forecasting
  (FP&A), acquired via Adaptive Insights (2018).
- **Workday Prism Analytics & Reporting:** brings external/transactional data
  into the Workday data model for analytics.
- **Industry & adjacent solutions:** Workday for government, education,
  healthcare, financial services, plus scheduling/labor optimization (VNDLY,
  Peakon employee-voice, Evisort contract intelligence, and the 2025 acquisition
  of **Sana** for AI-native knowledge/search).
- **AI — "Illuminate" and agentic AI:** Workday Illuminate embeds generative and
  agentic AI across the suite; the company is rolling out **AI agents** (e.g.
  recruiting, contracts, finance) and an Agent System of Record, positioning AI
  as the next platform cycle. Management frames AI as "a bigger transformation
  than SaaS."

## Competitive Moat

- **Single unified data model** across HR and Finance on one multi-tenant
  codebase — every customer runs the same current version, enabling continuous
  updates and cross-domain analytics that stitched-together legacy suites cannot
  match.
- **High switching costs / stickiness:** system-of-record for the two most
  mission-critical back-office functions; multi-year contracts; gross retention
  in the high-90s%.
- **Enterprise trust and reference base** among the largest global employers,
  reinforced by a deep SI partner ecosystem.

## Markets & Channel Mix

- Predominantly **large-enterprise** and increasingly **medium-enterprise**
  buyers; expanding in **government, higher education, and healthcare**.
- Majority of revenue is US-based, with international (EMEA, APJ) a stated growth
  priority. Go-to-market is direct sales augmented by global SI partners.
...
## Financial Snapshot — FY2026 (ended Jan 31, 2026)

| Metric | FY2026 | FY2025 | FY2024 |
|---|---|---|---|
| Total revenue | $9,552M | $8,446M | $7,259M |
| Subscription revenue | $8,833M | $7,718M | $6,603M |
| Subscription growth | +14.4% | +16.9% | +18.6% |
